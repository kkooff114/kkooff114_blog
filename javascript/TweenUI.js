...
timeline.insert(new TweenLite({}, 0.0, {}), 8.0);
...
timeline.insert(TweenLite.to(layer_1, 1.74, {css: {top: -11, left: 23}, ease: Linear.easeNone}), 6.1);//移动
...
timeline.insert(TweenLite.to(layer_3, 1.08, {css: {scale: 1.7}, ease: Elastic.easeOut}), 0.24);
...
TweenLite.set(layer_3, {css: {autoAlpha: 1.0, left: 492, top: 228, scale: 0.1, rotation: 0.0}});
tui_go();
}
